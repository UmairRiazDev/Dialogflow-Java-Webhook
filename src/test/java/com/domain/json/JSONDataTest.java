...
public class JSONDataTest {
  ...
  String jsonHowTxt = "{\"id\":\"b19b7bb5-f5f6-4ea0-92d9-4df2ef377a08\",\"timestamp\":\"2017-12-30T17:33:17.49Z\",\"lang\":\"en\",\"result\":{\"source\":\"agent\",\"resolvedQuery\":\"Hey there\","
      + "\"action\":\"\",\"actionIncomplete\":false,\"parameters\":{},\"contexts\":[],\"metadata\":{\"intentId\":\"bbcae676-2fa0-4ecf-a39c-7df0ad9745e6\",\"webhookUsed\":\"false\","
      + "\"webhookForSlotFillingUsed\":\"false\",\"intentName\":\"How are you doing\"},\"fulfillment\":{\"speech\":\"It will cost djffdjg\",\"messages\":[{\"type\":0,\"speech\":\"It will cost djffdjg\"}]},\"score\":1},"
      + "\"status\":{\"code\":200,\"errorType\":\"success\",\"webhookTimedOut\":false},\"sessionId\":\"1252c0c5-68b1-4a71-af00-05c809f6f1a5\"}\n";
  ...
  public void testCreateHelloResponse() throws JSONException {
    ...
    assertEquals(object.getString("speech"), "Hola");
  }
  @Test
  public void testCreateHowResponse() throws JSONException {
    
    String content = creatorFactory.createResponse(jsonHowTxt);
    assertNotNull(content);
    org.codehaus.jettison.json.JSONObject object =
        new org.codehaus.jettison.json.JSONObject(content);
    assertEquals(object.getString("speech"), "Never feel better! Thanks. What can I do for you?");
    ...
    public void testCreatePriceResponse() throws JSONException {
      ...
      org.codehaus.jettison.json.JSONObject object =
          new org.codehaus.jettison.json.JSONObject(content);
      assertEquals(object.getString("speech"), "The item will cost 200€");
    ...
    public void testCreateDeliveryTimeResponse() throws JSONException {
      ...
      org.codehaus.jettison.json.JSONObject object =
          new org.codehaus.jettison.json.JSONObject(content);
      assertEquals(object.getString("speech"), "The item will arrive to your shipping address tomorrow morning");
    }
    ...
    public void testCreateTraceResponse() throws JSONException {
      ...
      org.codehaus.jettison.json.JSONObject object =
          new org.codehaus.jettison.json.JSONObject(content);
      assertEquals(object.getString("speech"), "The item has been shipped via the Post Office");
    }
